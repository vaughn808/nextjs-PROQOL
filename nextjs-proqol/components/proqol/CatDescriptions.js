...
export default function CatDescriptions() {
    ...
    return (
        <div>
            ...
            <Divider />
            <Typography className={classes.padTop} paragraph>
            ...
            <Typography color = 'textSecondary' className={classes.padTop} paragraph>
            ...
            <Typography color = 'textSecondary' className={classes.padTopBot} paragraph>
